...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 34, 46, 37);
        ...
        static int _g_get_clearFlags(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Camera __cl_gen_to_be_invoked = (UnityEngine.Camera)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineCameraClearFlags(L, __cl_gen_to_be_invoked.clearFlags);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_stereoActiveEye(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Camera __cl_gen_to_be_invoked = (UnityEngine.Camera)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineCameraMonoOrStereoscopicEye(L, __cl_gen_to_be_invoked.stereoActiveEye);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
