...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineFontStyleWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(UnityEngine.FontStyle), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(UnityEngine.FontStyle), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(UnityEngine.FontStyle), L, null, 5, 0, 0);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Normal", UnityEngine.FontStyle.Normal);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Bold", UnityEngine.FontStyle.Bold);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Italic", UnityEngine.FontStyle.Italic);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "BoldAndItalic", UnityEngine.FontStyle.BoldAndItalic);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(UnityEngine.FontStyle), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushUnityEngineFontStyle(L, (UnityEngine.FontStyle)LuaAPI.xlua_tointeger(L, 1));
            }
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
			    if (LuaAPI.xlua_is_eq_str(L, 1, "Normal"))
                {
                    translator.PushUnityEngineFontStyle(L, UnityEngine.FontStyle.Normal);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Bold"))
                {
                    translator.PushUnityEngineFontStyle(L, UnityEngine.FontStyle.Bold);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Italic"))
                {
                    translator.PushUnityEngineFontStyle(L, UnityEngine.FontStyle.Italic);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "BoldAndItalic"))
                {
                    translator.PushUnityEngineFontStyle(L, UnityEngine.FontStyle.BoldAndItalic);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for UnityEngine.FontStyle!");
                }
            }
            else
            {
                return LuaAPI.luaL_error(L, "invalid lua type for UnityEngine.FontStyle! Expect number or string, got + " + lua_type);
            }
