...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRenderTextureWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 8, 15, 12);
        ...
        static int _m_GetTemporary_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 7&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<UnityEngine.RenderTextureFormat>(L, 4)&& translator.Assignable<UnityEngine.RenderTextureReadWrite>(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)&& translator.Assignable<UnityEngine.VRTextureUsage>(L, 7)) 
                {
                    int width = LuaAPI.xlua_tointeger(L, 1);
                    int height = LuaAPI.xlua_tointeger(L, 2);
                    int depthBuffer = LuaAPI.xlua_tointeger(L, 3);
                    ...
                    UnityEngine.RenderTextureReadWrite readWrite;translator.Get(L, 5, out readWrite);
                    int antiAliasing = LuaAPI.xlua_tointeger(L, 6);
                    UnityEngine.VRTextureUsage vrUsage;translator.Get(L, 7, out vrUsage);
                    
                        UnityEngine.RenderTexture __cl_gen_ret = UnityEngine.RenderTexture.GetTemporary( width, height, depthBuffer, format, readWrite, antiAliasing, vrUsage );
                        translator.Push(L, __cl_gen_ret);
