    ...
    public class UnityEngineUIInputFieldWrap 
    {
        ...
        static int _g_get_contentType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.InputField __cl_gen_to_be_invoked = (UnityEngine.UI.InputField)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineUIInputFieldContentType(L, __cl_gen_to_be_invoked.contentType);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_lineType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.InputField __cl_gen_to_be_invoked = (UnityEngine.UI.InputField)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineUIInputFieldLineType(L, __cl_gen_to_be_invoked.lineType);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_inputType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.InputField __cl_gen_to_be_invoked = (UnityEngine.UI.InputField)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineUIInputFieldInputType(L, __cl_gen_to_be_invoked.inputType);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_characterValidation(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.InputField __cl_gen_to_be_invoked = (UnityEngine.UI.InputField)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineUIInputFieldCharacterValidation(L, __cl_gen_to_be_invoked.characterValidation);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
